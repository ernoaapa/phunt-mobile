...
(function () {
    ...
    function newContext(contextName) {
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                //config object before require-1.0.7.js is loaded.
    ...
    if (isBrowser) {
        //Figure out baseUrl. Get it from the script tag with require-1.0.7.js in it.
        scripts = document.getElementsByTagName("script");
    ...
    //works well in that environment, since require-1.0.7.js is normally
    ...
    //If modules are built into require-1.0.7.js, then need to make sure dependencies are
    //traced. Use a setTimeout in the browser world, to allow all the modules to register
    //themselves. In a non-browser env, assume that modules are not built into require-1.0.7.js,
